 ...
 *
 * @see https://github.com/vqmod/vqmod
 */
...
abstract class VQMod
{
     ...
     * @var string
     */
    public static string $_vqversion = '2.6.8';
     ...
     * @var array
     */
    private static array $_mods = [];

    /**
     * Array of already modified files
     *
     * @var array
     */
    private static array $_filesModded = [];

    /**
     * Array of files not to apply modifications to
     *
     * @var array
     */
    private static array $_doNotMod = [];
    ...
    /**
     * Flag for already checked log/cache folders exist
     *
     * @var bool
     */
    private static bool $_folderChecks = false;

    /**
     * Full cache folder path
     *
     * @var string
     */
    private static string $_cachePathFull = '';

    /**
     * Integer representing the last time anything was modified
     *
     * @var int
     */
    private static int $_lastModifiedTime = 0;

    /**
     * Flag for developer mode - disables caching while true
     *
     * @var bool
     */
    ...
    /**
     * Path log folders are stored in
     *
     * @var string
     */
    public static string $logFolder = 'vqmod/logs/';

    /**
     * Relative path to cache file directory
     *
     * @var string
     */
    public static string $vqCachePath = 'vqmod/vqcache/';

    /**
     * Relative path to serialized mods array cache file
     *
     * @var string
     */
    public static string $modCache = 'vqmod/mods.cache';

    /**
     * Relative path to already checked files array cache file
     *
     * @var string
     */
    public static string $checkedCache = 'vqmod/checked.cache';

    /**
     * Relative path to protected files array cache file
     *
     * @var string
     */
    public static string $protectedFilelist = 'vqmod/vqprotect.txt';

    /**
     * Relative path to dynamic path replacement file
     *
     * @var string
     */
    public static string $pathReplaces = 'vqmod/pathReplaces.php';

    /**
     * Flag to enabled/disable logging
     *
     * @var bool
     */
    ...
    /**
     * Reference to the current file being modified by vQmod for logging
     *
     * @var bool
     */
    public static bool $fileModding = false;

    /**
     * System directory separator (/ or \ depending on OS)
     *
     * @var string
     */
    ...
    /**
     * Array of regex replaces to perform on file paths
     *
     * @var array
     */
    public static array $replaces = array();

    /**
     * Flag determining if windows or *nix based
     *
     * @var bool
     */
