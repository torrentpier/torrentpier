...
$lang['YOU_LAST_VISIT'] = 'Ваш останній візит: <span class="tz_time">%s</span>';
...
$lang['CODE_COPIED'] = 'Код скопійований в буфер обміну';
$lang['CODE_COPY'] = 'скопіювати в буфер обміну';
...
$lang['CRITICAL_INFORMATION'] = 'Критична інформація';

$lang['GENERAL_ERROR'] = 'Помилка';
$lang['CRITICAL_ERROR'] = 'Критична помилка';
$lang['AN_ERROR_OCCURED'] = 'Сталась помилка';
$lang['A_CRITICAL_ERROR'] = 'Сталась критична помилка';

$lang['ADMIN_REAUTHENTICATE'] = 'Щоб отримати доступ до адмін/мод панелі, вам необхідно ще раз ввести пароль.';
$lang['LOGIN_ATTEMPTS_EXCEEDED'] = 'Було перевищено максимальну кількість в %s спроб входу. Ви можете увійти через %s хвилин.';
...
$lang['FTP_ERROR_CONNECT'] = "Неможливо з'єднатися з сервером FTP: \'%s\'. Будь ласка, перевірте ваші налаштування FTP.";
...
$lang['FTP_ERROR_PATH'] = 'Немає доступу до директорії: \'%s\'. Будь ласка, перевірте ваші налаштування FTP.';
$lang['FTP_ERROR_UPLOAD'] = 'Неможливо записати файли в директорію: \'%s\'. Будь ласка, перевірте ваші налаштування FTP.';
$lang['FTP_ERROR_DELETE'] = 'Неможливо видалити файли в директорії: \'%s\'. Будь ласка, перевірте ваші настройки FTP.<br />Іншою причиною цієї помилки може бути відсутність файлу, перевірте спочатку приховані вкладення.';
$lang['FTP_ERROR_PASV_MODE'] = 'Неможливо включити/відключити пасивний режим';
...
// FTP
$lang['ATTACHMENT_FTP_SETTINGS'] = 'Параметри завантажування вкладень на FTP';
$lang['FTP_CHOOSE'] = 'Виберіть метод скачування';
$lang['FTP_OPTION'] = '<br />У цій версії PHP включені можливості FTP, ви можете спробувати спочатку автоматично закачати файл налаштувань по FTP в потрібний каталог.';
$lang['FTP_INSTRUCTS'] = 'Ви вирішили закачати файл налаштувань по FTP в каталог, що містить phpBB 2. Будь ласка, виберіть інформацію, необхідну для здійснення цього процесу. Врахуйте, що шлях FTP повинен бути повним шляхом до вашої установці phpBB 2, як якщо б ви користувалися звичайним клієнтом FTP.';
$lang['FTP_INFO'] = 'Вкажіть налаштування FTP';
$lang['ATTEMPT_FTP'] = 'Спробувати закачати файл налаштувань по FTP';
$lang['SEND_FILE'] = 'надіслати файл, я завантажу його вручну';
$lang['FTP_PATH'] = 'Шлях до каталогу FTP phpBB 2';
$lang['FTP_USERNAME'] = "Ім'я користувача FTP";
$lang['FTP_PASSWORD'] = 'Пароль для FTP';
$lang['TRANSFER_CONFIG'] = 'Почати закачування';
$lang['NOFTP_CONFIG'] = 'Спроба закачати файл налаштувань по FTP завершилася невдачею. Будь ласка, скачайте файл налаштувань і помістіть його в потрібний каталог вручну.';
...
$lang['FTP_UPLOAD'] = 'Включити FTP завантаження';
$lang['FTP_UPLOAD_EXPLAIN'] = 'Включити закачування через FTP. Якщо поставите на "так", Вам потрібно буде настроїти параметри для FTP і папка для додатків не буде використовуватися.';
...
$lang['FTP_SERVER'] = 'FTP сервер для завантаження';
$lang['FTP_SERVER_EXPLAIN'] = 'Тут Ви можете задати IP адресу або домен FTP сервера, який використовуватиметься для завантаження файлів. Якщо залишите це поле порожнім, буде використовуватися сервер, на якому встановлений Ваш форум. Зауважте, що не можна додавати ftp:// або будь що до адреси, тільки ftp.foo.com або просто IP адресу.';

$lang['ATTACH_FTP_PATH'] = 'FTP шлях до папки закаченных файлів';
$lang['ATTACH_FTP_PATH_EXPLAIN'] = 'Папка для додатків. CMOD не потрібен. Будь ласка, не вставляйте Ваш IP або FTP адресу, тільки відносний або абсолютний шлях до папки на сервері.<br />Наприклад: /home/web/uploads';
$lang['FTP_DOWNLOAD_PATH'] = 'Посилання для скачування файлів з FTP';
$lang['FTP_DOWNLOAD_PATH_EXPLAIN'] = 'Вкажіть посилання до FTP, де лежать програми.<br />Якщо Ви використовуєте віддалений FTP сервер, вкажіть повну адресу, наприклад: http://www.mystorage.com/phpBB2/upload.<br />Якщо Ви використовуєте локальний сервер для програм, задайте відносний адресу до папки форуму "upload".<br />Слеш буде видалено. Залиште поле порожнім, якщо FTP недоступний з інтернету. Якщо поле буде порожнім, фізичний метод скачування буде недоступний.';
$lang['FTP_PASSIVE_MODE'] = 'Задіяти пасивний режим FTP';
$lang['FTP_PASSIVE_MODE_EXPLAIN'] = "Команда PASV просить віддалений сервер відкрити порт для зв'язку і повідомити номер даного порту. Віддалений сервер відкриває порт і клієнт підключається до нього.";

$lang['NO_FTP_EXTENSIONS_INSTALLED'] = 'Ви не можете використовувати FTP для завантаження файлів, тому що Ваш PHP не підтримує цю можливість.';
...
$lang['CATEGORY_STREAM_FILES'] = 'Потокові файли';
$lang['CATEGORY_SWF_FILES'] = 'Flash файли';
...
$lang['SETTINGS_CAT_STREAMS'] = 'Налаштування для спеціальної категорії: Потокові файли';
...
$lang['SEARCH_INVALID_STYLE'] = 'Обран неправильний стиль';
...
$lang['SEARCH_NO_REGEXP'] = 'База даних не підтримує пошук за регулярними виразами.';
...
$lang['SEARCH_USERNAME_EXPLAIN'] = 'Тут можна зробити регістронезавісімий пошук імені користувача. Якщо ви хочете задати тільки частину імені, використовуйте * (зірочку) як маску. Вибір регулярних виразів дозволить шукати за зразком.';
$lang['SEARCH_EMAIL_EXPLAIN'] = ' Введіть вираз, відповідний до адресу email користувачів. Регістр не має значення. Для здійснення пошуку по частковому збігу, використовуйте * (зірочку) як маску. Вибір регулярних виразів дозволить шукати за зразком.';
...
$lang['SEARCH_USERS_USERFIELD_EXPLAIN'] = 'Пошук користувачів з різних полів профілю. В якості маски можна зірочки (*). Вибір регулярних виразів дозволить шукати за зразком.';
...
$lang['REGULAR_EXPRESSION'] = 'Регулярний вираз?';
