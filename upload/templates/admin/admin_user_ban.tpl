...
<table width="80%" class="forumline">
	...
	<tr>
	  <td class="row1">{L_USERNAME}: <br /><span class="small">{L_UNBAN_USER_EXPLAIN}</span></td>
	...
	<tr>
	  <td class="row1">{L_IP_OR_HOSTNAME}: <br /><span class="small">{L_BAN_IP_EXPLAIN}</span></td>
	...
	<tr>
	  <td class="row1">{L_IP_OR_HOSTNAME}: <br /><span class="small">{L_UNBAN_IP_EXPLAIN}</span></td>
