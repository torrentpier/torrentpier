 ...
 * 1. Running install/scripts/migrate_attachments.php to move existing files
...
final class RemoveAttachModTables extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        // Check if there are any topics with attach_ext_id = 0 that have torrents in an old system
        ...
        if ($result && $result['cnt'] > 0) {
            throw new \RuntimeException(
                ...
                "Please run install/scripts/migrate_attachments.php first."
            );
        }
        ...
        // Remove the attach_id column from bb_bt_torrents if it exists
