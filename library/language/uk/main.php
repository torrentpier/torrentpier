...
$lang['HIDE_CAT_MESS'] = 'Частина категорій прихована "Опціями показу" &middot; <a href="index.php?sh=1">Показати всі</a>';
$lang['TOPIC'] = 'Тема';
$lang['TOPICS'] = 'Теми';
...
// Stats block text
$lang['POSTED_TOPICS_TOTAL'] = 'Користувачі створили тем: <b>%s</b>'; // Number of topics
...
// Tracker stats
$lang['TORRENTS_STAT'] = 'Торентів: <b style="color: blue;">%s</b>,&nbsp; Загальний розмір: <b>%s</b>'; // first %s = number of torrents, second %s is the total size.
$lang['PEERS_STAT'] = 'Пірів: <b>%s</b>,&nbsp; Сідів: <b class="seedmed">%s</b>,&nbsp; Лічерів: <b class="leechmed">%s</b>'; // first %s = number of peers, second %s = number of seeders,  third %s = number of leechers.
$lang['SPEED_STAT'] = 'Загальна швидкість: <b>%s</b>&nbsp;'; // %s = total speed.
...
$lang['RULES_POST_CAN'] = 'Ви <b>можете</b> створювати нові теми на форумі';
$lang['RULES_POST_CANNOT'] = 'Ви <b>не можете</b> створювати нові теми на форумі';
$lang['RULES_REPLY_CAN'] = 'Ви <b>можете</b> відповідати в темах на форумі';
...
$lang['MODERATE_TOPIC'] = 'Модерувати цю тему';
...
$lang['EDIT_POST_AJAX'] = 'Ви не можете редагувати повідомлення зі статусом ';
...
$lang['NOT_EDIT_TOR_STATUS'] = 'Ви не можете редагувати реліз зі статусом';
...
$lang['POST_HAS_NO_POLL'] = 'Ця тема не має опитування';
...
$lang['POLL_DELETE'] = 'Ваше опитування було успішно вилучено.';
...
$lang['FONT_COLOR'] = 'Колір шрифту';
$lang['COLOR_DEFAULT'] = 'Типово';
...
$lang['MESSAGE_SENT'] = '<b>Ваше повідомлення надіслано.</b>';

$lang['CLICK_RETURN_INBOX'] = 'Повернутися до:<br /><br /> %s<b>Вхідні</b>%s';
...
$lang['EMAIL_BANNED'] = 'Вибачте, але адреса <b>%s</b> знаходиться в чорному списку.';
...
$lang['GROUP_JOINED'] = 'Ви успішно підписані на групу.<br />Ви отримаєте сповіщення, коли підписка буде затверджена модератором групи.';
...
$lang['SEARCH_ERROR'] = 'У даний момент пошукова система недоступна<br /><br />Спробуйте повторити запит через кілька секунд';
...
$lang['AUTH_USERS_GRANTED_ACCESS'] = '<b>користувачі із спеціальними правами доступу</b>';
...
$lang['RULES_ATTACH_CANNOT'] = 'Ви <b>не можете</b> прикріплювати файли';
$lang['RULES_DOWNLOAD_CAN'] = 'Ви <b>можете</b> завантажувати файли';
$lang['RULES_DOWNLOAD_CANNOT'] = 'Ви <b>не можете</b> завантажувати файли';
...
$lang['ATTACHMENT_PHP_SIZE_NA'] = 'Прикріплення занадто велике.<br />Не вдалося перевищити обмеження встановлене в PHP.<br />Attachment Mod не може визначити максимальний розмір для файлів які завантажуються, визначений в php.ini.';
$lang['ATTACHMENT_PHP_SIZE_OVERRUN'] = 'Вкладення занадто велике.<br />Максимальний розмір файлу, що завантажується: %d MB.<br />Зверніть увагу, що ця величина визначена в php.ini та Attachment Mod не може змінити це значення в більшу сторону.'; // replace %d with ini_get('upload_max_filesize')
...
$lang['ATTACHMENT_TOO_BIG'] = 'Вкладення занадто велике.<br/>Максимальний розмір: %d'; // replace %d with maximum file size, %s with size var
...
$lang['DIRECTORY_NOT_WRITEABLE'] = 'Папка \'%s\' недоступна для запису. Вам потрібно створити папку для завантажень та виконати chmod 777 (або змінити власника httpd-servers) для завантаження файлів на сервер.<br />Якщо у вас тільки FTP доступ до сервера змініть \'Атрибути\' папки на rwxrwxrwx.'; // replace %s with directory
...
$lang['BT_LOW_RATIO_FOR_DL'] = "З рейтингом <b>%s</b> Ви не можете завантажувати нові торренти.<br /><br />Для підвищення рейтингу Ви можете що-небудь поставити на роздачу з <b>Ваших минулих завантажень</b>, або організувати нову роздачу.<br /><br /><b>Прийміть до уваги, що Ваша участь у системі BitTorrent не може обмежуватися тільки завантаженням!</b>";
$lang['BT_RATIO_WARNING_MSG'] = 'Якщо ваш рейтинг впаде нижче %s, ви не зможете завантажувати торренти! <a href="%s"><b>Детальніше про рейтинг.</b></a>';
...
$lang['CLICK_RETURN_ADMIN_INDEX'] = '%sПовернутися на головну сторінку адмін розділу%s';
...
$lang['HOT_THRESHOLD'] = 'Повідомлень в &laquo;популярній&raquo; темі';
...
$lang['FORUM_PRUNE_EXPLAIN'] = 'Це видалить будь-яку тему, яка не мала нових повідомлень протягом заданої кількості днів. Якщо Ви не введете число, тоді всі теми буде видалено. Не будуть видалені <b>прикріплені</b> теми та <b>анонси</b>. Вам доведеться видаляти ці теми вручну.';
...
$lang['WORDS_EXPLAIN'] = 'Тут ви можете додавати, змінювати або видаляти слова, які будуть автоматично піддаватися цензурі на Ваших форумах. Крім того, користувачі не зможуть зареєструватися з іменами, що містять ці слова. У списку слів можуть використовуватися шаблони (*), тобто до шаблону \'*тест*\' підійдуть слова \'протестувати\', \'тест*\' &mdash; \'тестування\', \'*тест\' &mdash; \'протест\'.<br />Рекомендую користуватися цією функцією <b>дуже</b> акуратно.';
$lang['WORD'] = 'Слово';
...
$lang['STYLE_COLOR_FAQ'] = 'Вкажіть class, щоб задати званню потрібний колір. Наприклад, <i class="bold">колір тексту<i>';
...
$lang['NEWS_FORUM_ID'] = 'З яких форумів відображати <br /> <h6>З декількох форумів виводите, через кому. Наприклад 1,2,3</h6>';
...
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Мінімальний розмір роздачі, за який будуть нараховуватися бонуси</h4><h6>Якщо хочете нараховувати бонуси за всі роздачі, залиште поле порожнім.</h6>';
...
$lang['REBUILD_SEARCH_DESC'] = 'Ця функція індексує таблиці пошуку. Індексація може зайняти деякий час.<br />Будь ласка, не закривайте цю сторінку до завершення індексації';
...
$lang['NUM_OF_POSTS_EXPLAIN'] = 'Загальна кількість записів в процесі<br />Автоматично заповнюється кількість від загального/залишкового числа записів, знайдених в БД';

$lang['POSTS_PER_CYCLE'] = 'Записів за цикл';
$lang['POSTS_PER_CYCLE_EXPLAIN'] = 'Кількість записів для обробки за один цикл<br />Тримайте її низькою, щоб уникнути таймауту PHP / веб-сервера';

$lang['REFRESH_RATE'] = 'Період оновлення';
$lang['REFRESH_RATE_EXPLAIN'] = 'Скільки часу (сек) чекати перед переходом до наступного циклу обробки<br />Зазвичай Вам не потрібно це змінювати';
...
$lang['DISABLE_BOARD_EXPLAIN_ALREADY'] = '<i>Ваш форум вже вимкнено</i>';
...
$lang['PROCESS_DETAILS'] = '<b>%s</b> до <b>%s</b> (із загального <b>%s</b>)';
...
$lang['REBUILD_SEARCH_ABORTED'] = 'Перебудову пошуку перервано на post_id %s.<br /><br />Якщо Ви перервали процес обробки, Ви повинні почекати кілька хвилин до запуску перебудови пошуку знову, щоб останній цикл можна було завершити.';
...
$lang['TPL_NOT_IMG_URL'] = '<b>%s</b> - має бути http:// посилання на зображення';
...
$lang['SITEMAP_GOOGLE_1'] = 'Зареєструйте Ваш сайт на <a href="http://www.google.com/webmasters/" target="_blank">Google Webmaster</a> з використанням Вашого облікового запису Google.';
...
$lang['SITEMAP_YANDEX_1'] = 'Зареєструйте Ваш сайт на <a href="http://webmaster.yandex.ru/sites/" target="_blank">Yandex Webmaster</a> з використанням Вашого облікового запису Yandex.';
$lang['SITEMAP_YANDEX_2'] = '<a href="http://webmaster.yandex.ru/site/map.xml" target="_blank">Додайти файл sitemap</a> зареєстрованого Вами сайту.';
