...
$lang['ADMIN'] = 'ma\'murlashtirish';
$lang['FORUM'] = 'Forum';
$lang['CATEGORY'] = 'kategoriya';
$lang['HIDE_CAT'] = 'yashir kategoriyalar';
$lang['HIDE_CAT_MESS'] = 'Ba\'zi toifalar moslashtirilgan displey opsiyalari orqali yashiringan';
...
$lang['LONGEVITY'] = 'ro\'yxatga olingan';
...
$lang['ONLINE_USERS'] = '%2$d ro\'yxatdan o\'tgan va %3$d mehmonlar: Jami onlayn <b>%1$d</b> foydalanuvchilar mavjud';
$lang['RECORD_ONLINE_USERS'] = 'hech onlayn eng foydalanuvchilar %s haqida <b>%s</b> edi'; // first %s = number of users, second %s is the date.
...
// Stats block text
$lang['POSTED_TOPICS_TOTAL'] = 'Bizning foydalanuvchilar <b>%s</b> mavzularda jami tashlashdi'; // Number of topics
$lang['POSTED_ARTICLES_ZERO_TOTAL'] = 'Bizning foydalanuvchilar <b>0</b> maqola jami tashlashdi'; // Number of posts
$lang['POSTED_ARTICLES_TOTAL'] = 'Bizning foydalanuvchilar <b>%s</b> maqola jami tashlashdi'; // Number of posts
$lang['REGISTERED_USERS_ZERO_TOTAL'] = 'Biz <b>0</b> ro\'yxatdan o\'tgan foydalanuvchi bor'; // # registered users
$lang['REGISTERED_USERS_TOTAL'] = 'Biz <b>%s</b> ro\'yxatdan o\'tgan foydalanuvchi bor'; // # registered users
$lang['USERS_TOTAL_GENDER'] = 'Boys: <b>%d</b>, Qizlar: <b>%d</b>, Boshqalar: <b>%d</b>';
$lang['NEWEST_USER'] = 'eng yangi ro\'yxatga olingan foydalanuvchi <b>%s</b> emas'; // a href, username, /a

// Tracker stats
$lang['TORRENTS_STAT'] = 'Torrent\'ler: <b style="color: blue;">%s</b>,&nbsp; Jami hajmi: <b>%s</b>'; // first %s = number of torrents, second %s is the total size.
$lang['PEERS_STAT'] = 'Tengdoshlari: <b>%s</b>,&nbsp; non: <b class="seedmed">%s</b>,&nbsp; Leechers: <b class="leechmed">%s</b>'; // first %s = number of peers, second %s = number of seeders,  third %s = number of leechers.
$lang['SPEED_STAT'] = 'Umumiy tezligi: <b>%s</b>&nbsp;'; // %s = total speed.
...
$lang['RULES_POST_CAN'] = 'Siz bu forumda yangi mavzu ocha <b>can</b>';
$lang['RULES_POST_CANNOT'] = 'Siz bu forumda yangi mavzu ocha <b>cannot</b>';
$lang['RULES_REPLY_CAN'] = 'Siz bu forumda mavzularga javob <b>can</b>';
$lang['RULES_REPLY_CANNOT'] = 'Siz bu forumda mavzularga javob <b>cannot</b>';
$lang['RULES_EDIT_CAN'] = 'Siz bu forumdagi xabarlaringizni tahrir <b>can</b>';
$lang['RULES_EDIT_CANNOT'] = 'Siz bu forumdagi xabarlaringizni tahrir <b>cannot</b>';
$lang['RULES_DELETE_CAN'] = 'Siz bu forumda siz xabarlarni o\'chirishingiz <b>can</b>';
$lang['RULES_DELETE_CANNOT'] = 'Siz bu forumda siz xabarlarni o\'chirishingiz <b>cannot</b>';
$lang['RULES_VOTE_CAN'] = 'Siz bu forumda So\'rov ovoz <b>can</b>';
...
$lang['MESSAGE_SENT'] = '<b>Your Xabar sent.</b> bo\'ldi';

$lang['CLICK_RETURN_INBOX'] = 'siz qaytish: <br /><br /> %s<b>Inbox</b>%s';
...
$lang['VIEWING_MY_PROFILE'] = 'Mening profili [<a href="%s">Settings / Change profile</a>]';
...
$lang['DATE_FORMAT_EXPLAIN'] = 'ishlatiladigan sintaktik PHP <a href=\'https://www.php.net/manual/en/function.date.php\' target=\'_other\'>date () </a> funktsiyasi bilan bir xil bo\'ladi.';
...
$lang['EMAIL_BANNED'] = 'Kechirasiz, lekin <b>%s</b> manzili man qilindi.';
...
$lang['GROUP_JOINED'] = 'Siz muvaffaqiyatli obuna guruhi moderator tomonidan tasdiqlangan bo\'lsa xabar beriladi, bu group.<br />You obuna qilgan.';
...
$lang['SEARCH_WORDS_EXPL'] = 'Siz natijalari bo\'lishi kerak va <b>-</b> natijasida (: "+ word1 -word2" ex) bo\'lmasligi kerak so\'zlarni aniqlash uchun so\'zlarni aniqlash uchun <b> + </b> foydalanishingiz mumkin. qisman o\'yinlarda uchun * belgisini joker sifatida foydalaning';
...
$lang['AUTH_USERS_GRANTED_ACCESS'] = '<b>users maxsus access</b> berilgan';
...
$lang['ALL_TIMES'] = 'Barcha marta <span class="tz_time">%s</span> bo\'ladi'; // This is followed by UTC and the timezone offset
...
// Auth Related Entries
$lang['RULES_ATTACH_CAN'] = 'Siz bu forumda fayllarni qo\'shishingiz <b>can</b>';
$lang['RULES_ATTACH_CANNOT'] = 'Siz bu forumda fayllarni qo\'shishingiz <b>cannot</b>';
$lang['RULES_DOWNLOAD_CAN'] = 'Siz bu forumda fayllarni yuklab <b>can</b>';
$lang['RULES_DOWNLOAD_CANNOT'] = 'Siz bu forumda fayllarni yuklab <b>cannot</b>';
...
$lang['ATTACHMENT_PHP_SIZE_NA'] = 'Ilova Tartibni php.ini belgilangan maksimal upload hajmi aniqlash olmaydi PHP.<br />The ilovada belgilangan maksimal hajmi olish emas big.<br />Could ham bo\'ladi.';
...
$lang['TOR_AUTH_SENT_COMMENT'] = 'moderator yuborilgan &middot; <span class="seed bold">The ma\'lumot. Expect.</span>';
...
$lang['FILTER_BY_NAME'] = 'nomi </i> tomonidan <i>Filter';
...
$lang['TOPICS_DOWN_SETS'] = 'Mavzu holati <b>Download</b> o\'zgardi';
$lang['TOPICS_DOWN_UNSETS'] = '<b>Download</b> holat olib';
...
$lang['BONUS_UPLOAD_DESC'] = '<b>%s sizning tarqatish yig\'indisi uchun qo\'shiladi %1$s trafik ustida bonus ballarini boglanmoq <br /> distribution</b> uchun.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'narx';
$lang['EXCHANGE_NOT'] = 'mavjud emas almashish';
$lang['BONUS_SUCCES'] = 'siz uchun muvaffaqiyatli %s sanab bo\'ladi';
$lang['BONUS_NOT_SUCCES'] = '<span class="leech">You mavjud bonuslarni yo\'q. Qo\'shimcha ko\'chat! </span>';
...
$lang['BT_LOW_RATIO_FOR_DL'] = "nisbati bilan <b>%s</b> siz torrent yuklab mumkin emas";
$lang['BT_RATIO_WARNING_MSG'] = 'Sizning nisbati %s ostiga tushsa, siz Torrents yuklab olmaysiz! rating.</b></a> haqida <a href="%s"><b>More';
...
$lang['ALREADY_REG_IP'] = 'Sizning IP-manzil bilan allaqachon foydalanuvchi %s ro\'yxatdan o\'tgan. Agar ilgari <a href="mailto:%s">Administrator</a> bizning shogirdi, pochta ro\'yxatdan o\'tgan bo\'lsangiz';
...
$lang['REGISTERED_IN_TIME'] = "on Ro'yxatdan bo'lgan paytda closed<br /><br />You endi (17:00 MSK uchun 01:00 dan ro'yxatdan mumkin" . date('H:i') . "MSK) <br /><br />We bu noqulayliklar uchun uzr so'raymiz";
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'yangilash uchun yuqoriga olib tashlash keyin <b>entire u allaqachon o\'chirib mavzularni ko\'rsatilgan mumkin list</b>';
...
$lang['FORUM_PRUNE_EXPLAIN'] = 'Bu sizga tanlash miqdordagi kun ichida yuborilgan qilinmagan har qanday mavzuni o\'chirib tashlaydi. Bas, bir qator kiriting bo\'lmasa barcha mavzular o\'chiriladi. Bu <b>sticky</b> mavzularni va <b>announcements</b> olib tashlash emas. Siz qo\'lda shu mavzularni olib tashlash kerak bo\'ladi.';
...
$lang['NEWS_FORUM_ID'] = 'forumlar, vergul bilan ajratilgan kun tartibiga olib, bir necha forumlarda <h6>Of <br /> namoyish qilish uchun nima boshlab. misol 1,2,3</h6>';
...
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Minimum tarqatish, buning uchun siz barcha tarqatish uchun bonuslar hisoblash bo\'lsangiz, bo\'sh qoldiring bonuslar </h4> <h6> taqdirlanadi. </h6>';
$lang['SEED_BONUS_USER_REGDATA'] = 'Agar barcha foydalanuvchilar uchun bonuslar kelgan bo\'lsangiz bonuslar </h4> <h6> taqdirlanadi keyin foydalanuvchi Tracker\'ın <h4>Minimum uzunligi, bo\'sh qoldiring. </h6>';
...
$lang['IMAGE_LINK_SIZE_EXPLAIN'] = 'bir surat, bu belgilangan mezon etib bo\'lsa, tasvir Inline View u 0x0 o\'rnatilgan bo\'ladi .<br />If (piksel deb kengligi x balandligi) yoqilgan <br />if u, inlined ancha namoyon ko\'ra, bir Link sifatida paydo bo\'ladi, bu xususiyat o\'chirilgan. ba\'zi tasvir bilan ajralib tufayli PHP cheklanishi ishlamaydi.';
...
$lang['BT_SELECT_FORUMS_EXPL'] = 'bir necha forumlar tanlashda esa <i>Ctrl</i> ushlab turing';
...
$lang['BT_SHOW_IP_ONLY_MODER'] = 'Tengdoshlari "<b>IP</b>s Moderatorlar ko\'rinadigan faqat';
$lang['BT_SHOW_PORT_ONLY_MODER'] = 'Tengdoshlari "<b>Port</b>s Moderatorlar ko\'rinadigan faqat';
...
$lang['REBUILD_SEARCH_DESC'] = 'Har bir forumda E\'lonni ushbu mod irodasi indeksi, qidiruv jadvallarni qayta qurish. Istalgan vaqtda Siz to\'xtatish mumkin va siz off.<br /><br />It ( "tsikl Xabarlar" qarab, uning taraqqiyot ko\'rsatish uchun uzoq vaqt talab va "Vaqt limiti mumkin tark qaerda, uni qayta ishga tushirish keyingi safar siz davom variant olaman u tugamaguncha albatta siz uni to\'xtatib istagan ekan "), shuning uchun, uning o\'sish sahifasidan harakat qilmang, iltimos.';

// Input screen
$lang['STARTING_POST_ID'] = 'boshlab post_id';
$lang['STARTING_POST_ID_EXPLAIN'] = 'ishlash from<br />You tanlashingiz mumkin boshlanadi birinchi post boshidan boshlash uchun yoki lavozimidan oxirgi to\'xtadi';
...
$lang['NUM_OF_POSTS_EXPLAIN'] = 'process<br />It ning avtomatik JB topilgan jami / Qolgan xabarlar soni bilan to\'ldiriladi umumiy xabarlar soni';

$lang['POSTS_PER_CYCLE'] = 'aylanishi boshiga Xabarlar';
$lang['POSTS_PER_CYCLE_EXPLAIN'] = 'cycle<br />Keep boshiga ishlash xabarlar soni u php / webserver vaqtini uzaytirish oldini olish uchun, past';
...
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Your php (xavfsiz rejimi) tuzilgan %s soniya vaqt tugashi ega, shuning uchun bu value</i> quyida qolish';
...
$lang['DISABLE_BOARD_EXPLAIN_ALREADY'] = '<i>Your kengashi allaqachon disabled</i> emas';
...
$lang['INFO_PROCESSING_FINISHED_NEW'] = 'Siz muvaffaqiyatli deb sanadan keyin %s,<br />but bor edi %s yangi post (lar) ustidan post_id %s (%s qayta xabarlar) da qayta ishlash yakunlandi';
...
$lang['PROCESS_DETAILS'] = '<b>%s</b> uchun <b>%s</b> dan (jami <b>%s</b> chiqib)';
...
$lang['INFO_ESTIMATED_VALUES'] = '(*) Barcha taxmin qiymatlari joriy yakunlandi foizi approximately<br />based hisoblanadi va yakunlandi foiz taxmin qiymatlari haqiqiy bo\'lgan yaqin keladi oshiradi haqiqiy final values.<br />As vakili mumkin emas.';

$lang['CLICK_RETURN_REBUILD_SEARCH'] = 'Izlash qayta qaytish uchun %shere%s bosing';
$lang['REBUILD_SEARCH_ABORTED'] = 'qayta ishlash bo\'yicha esa siz qoldirilgan %s.<br /><br />If qidiruv post_id da qoldirilgan qayta tiklash, siz yana Izlash qayta ishlaydigan qadar, ayrim daqiqa kutish kerak, shuning uchun o\'tgan davr tugatish mumkin.';
...
$lang['SITEMAP_YANDEX_1'] = 'Yandex hisobingizni yordamida <a href="https://webmaster.yandex.ru/sites/" target="_blank">Yandex Webmaster</a> saytida ro\'yxatdan.';
$lang['SITEMAP_YANDEX_2'] = 'sayt <a href="https://webmaster.yandex.ru/site/map.xml" target="_blank">Add sitemap</a> ro\'yxatdan.';
