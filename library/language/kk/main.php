...
$lang['ADMIN'] = 'әкімшілік';
$lang['FORUM'] = 'Форум';
$lang['CATEGORY'] = 'санат';
$lang['HIDE_CAT'] = 'санаттарын жасыру';
$lang['HIDE_CAT_MESS'] = 'Кейбір санаттар теңшелген дисплей опциялары арқылы жасырылады';
...
$lang['ONLINE_USERS'] = '%2$d тіркелген және %3$d қонақтар: Барлығы Онлайн <b>%1$d</b> пайдаланушылар бар';
$lang['RECORD_ONLINE_USERS'] = 'соңды онлайн ең пайдаланушылар %s туралы <b>%s</b> болды'; // first %s = number of users, second %s is the date.
...
// Stats block text
$lang['POSTED_TOPICS_TOTAL'] = 'Біздің пайдаланушылар <b>%s</b> тақырыптар жалпы жарияладыңыз'; // Number of topics
$lang['POSTED_ARTICLES_ZERO_TOTAL'] = 'Біздің пайдаланушылар <b>0</b> мақалалар жалпы жарияладыңыз'; // Number of posts
$lang['POSTED_ARTICLES_TOTAL'] = 'Біздің пайдаланушылар <b>%s</b> мақалалар жалпы жарияладыңыз'; // Number of posts
$lang['REGISTERED_USERS_ZERO_TOTAL'] = 'Біз <b>0</b> тіркелген пайдаланушылар'; // # registered users
$lang['REGISTERED_USERS_TOTAL'] = 'Біз <b>%s</b> тіркелген пайдаланушылар'; // # registered users
...
// Tracker stats
$lang['TORRENTS_STAT'] = 'Торрент: <b style="color: blue;">%s</b>,&nbsp; жалпы мөлшері: <b>%s</b>'; // first %s = number of torrents, second %s is the total size.
$lang['PEERS_STAT'] = 'Пир: <b>%s</b>,&nbsp; Сепкіштер: <b class="seedmed">%s</b>,&nbsp; Leechers: <b class="leechmed">%s</b>'; // first %s = number of peers, second %s = number of seeders,  third %s = number of leechers.
$lang['SPEED_STAT'] = 'Барлығы жылдамдығы: <b>%s</b>&nbsp;'; // %s = total speed.
...
$lang['RULES_POST_CAN'] = 'Сіз бұл Форумға жаңа тақырыптарды жариялауға <b>can</b>';
$lang['RULES_POST_CANNOT'] = 'Сіз бұл Форумға жаңа тақырыптарды жариялауға <b>cannot</b>';
$lang['RULES_REPLY_CAN'] = 'Сіз бұл форумда жауап <b>can</b>';
$lang['RULES_REPLY_CANNOT'] = 'Сіз бұл форумда жауап <b>cannot</b>';
$lang['RULES_EDIT_CAN'] = 'Сіз бұл форумға өз хабарламалар өңдей <b>can</b>';
$lang['RULES_EDIT_CANNOT'] = 'Сіз бұл форумға өз хабарламалар өңдей <b>cannot</b>';
$lang['RULES_DELETE_CAN'] = 'Сіз бұл форумға өз хабарларын жою <b>can</b>';
$lang['RULES_DELETE_CANNOT'] = 'Сіз бұл форумға өз хабарларын жою <b>cannot</b>';
$lang['RULES_VOTE_CAN'] = 'Сіз бұл форумға сауалнамаға дауыс <b>can</b>';
...
$lang['NEW_PMS_DECLENSION'] = ['жаңа хабар', 'жаңа хабарлар'];

$lang['UNREAD_PMS_FORMAT'] = '<b>%1$s</b> %2$s'; // 1 new message
$lang['UNREAD_PMS_DECLENSION'] = ['оқылмаған', 'оқылмаған'];
...
$lang['MESSAGE_SENT'] = '<b>Your хабарлама sent.</b> болды';

$lang['CLICK_RETURN_INBOX'] = 'Сіздің оралу: <br /><br /> %s<b>Inbox</b>%s';
...
$lang['VIEWING_MY_PROFILE'] = 'Менің профилім [<a href="%s">Settings / өзгерту profile</a>]';
...
$lang['DATE_FORMAT_EXPLAIN'] = 'пайдаланылатын синтаксисі PHP <a href=\'https://www.php.net/manual/en/function.date.php\' target=\'_other\'>date () </a> функциясы бірдей.';
$lang['SIGNATURE'] = 'қол';
...
$lang['EMAIL_BANNED'] = 'Кешіріңіз, бірақ <b>%s</b> мекенжайы тыйым салынды.';
...
$lang['GROUP_JOINED'] = 'Сіз өзіңіздің жазылым тобы модератор бекіткен кезде хабарланады осы group.<br />You сәтті жазылдыңыз.';
...
$lang['SEARCH_ERROR'] = 'Қазіргі уақытта, іздеу жүйесі бірнеше секундтан кейін сұрау қайталау available<br /><br />Try емес,';
...
$lang['SEARCH_WORDS_EXPL'] = 'Сіз нәтижесінде (: «+ word1 -word2» бұрынғы) болуы тиіс емес сөздерді анықтауға нәтижелері болуы тиіс сөздер мен <b>-</b> анықтауға <b> + </b> пайдалануға болады. ішінара матчтарына арналған Үлгі ретінде пайдаланыңыз *';
...
$lang['AUTH_USERS_GRANTED_ACCESS'] = '<b>users арнайы access</b> берілген';
...
$lang['YOU_BEEN_BANNED'] = 'Сізге бұл форумнан тыйым салынған. Қосымша ақпарат алу үшін әкімшіге хабарласыңыз.';
...
$lang['ALL_TIMES'] = 'Барлық рет <span class="tz_time">%s</span> болып табылады'; // This is followed by UTC and the timezone offset
...
// Auth Related Entries
$lang['RULES_ATTACH_CAN'] = 'Сіз бұл форумға файлдарды бекіту <b>can</b>';
$lang['RULES_ATTACH_CANNOT'] = 'Сіз бұл форумға файлдарды бекіту <b>cannot</b>';
$lang['RULES_DOWNLOAD_CAN'] = 'Сіз бұл форумға <b>can</b> жүктеу файлдары';
$lang['RULES_DOWNLOAD_CANNOT'] = 'Сіз бұл форумға <b>cannot</b> жүктеу файлдары';
...
$lang['ATTACHMENT_PHP_SIZE_NA'] = 'Тіркеме тым максималды өлшемі PHP.<br />The Тіркеме Mod анықталған ала алмайды big.<br />Could отыр php.ini анықталған барынша мөлшері қотарып анықтау мүмкін емес.';
...
$lang['DIRECTORY_NOT_WRITEABLE'] = 'Directory «%s» жазуға болатындығын емес. Сіз жүктеу жолын жасау керек және сіз тек кәдімгі FTP-рұқсаты бар files.<br />If rwxrwxrwx каталог \'төлсипатын «өзгерту жүктеу үшін 777 (немесе сізге HTTPD-серверлер иесі иесін өзгерту) оны chmod болады.'; // replace %s with directory
...
$lang['ATTACHBOX_LIMIT'] = 'Сіздің Attachbox толық is<br /><b>%d%%</b>';
...
$lang['TOR_AUTH_SENT_COMMENT'] = 'модератор жіберілген &middot; <span class="seed bold">The ақпарат. Expect.</span>';
...
$lang['FILTER_BY_NAME'] = 'аты бойынша <i>Filter </i>';
...
$lang['TOPICS_DOWN_SETS'] = 'Тақырып мәртебесі <b>Download</b> өзгертілді';
$lang['TOPICS_DOWN_UNSETS'] = '<b>Download</b> мәртебесі алынып';
...
$lang['BONUS_UPLOAD_DESC'] = 'Сіздің бөлу сомасына бойынша қосылады %1$s трафик бойынша бонустық ұпай алмасу <br /> distribution</b> үшін <b>%s.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'баға';
$lang['EXCHANGE_NOT'] = 'алмасу қолжетімді емес';
$lang['BONUS_SUCCES'] = 'сізге ол %s сәтті енгізілген';
$lang['BONUS_NOT_SUCCES'] = '<span class="leech">You бонустар қолжетімді жоқ. Толығырақ себу! </span>';
...
$lang['BT_LOW_RATIO_FOR_DL'] = "қатынасы көмегімен сіз торрент жүктеу мүмкін емес <b>%s</b>";
$lang['BT_RATIO_WARNING_MSG'] = 'Егер қатынасы %s төмен түссе, сіз торренттің жүктеп алу үшін мүмкін болмайды! rating.</b></a> туралы <a href="%s"><b>More';

$lang['SEEDER_LAST_SEEN'] = 'Сепкіштер көрген емес: <b>%s</b>';
...
$lang['ALREADY_REG_IP'] = 'Сіздің IP-адрес өзінде пайдаланушыны %s тіркелген отырып. Егер сіз бұрын, біздің трекере <a href="mailto:%s">Administrator</a> поштаны тіркелген жоқ болса';
$lang['HIDDEN'] = 'жасырын';
...
$lang['REGISTERED_IN_TIME'] = "сәт тіркеу кезінде closed<br /><br />You қазір (17:00 мск үшін 01:00 тіркелуге болады табылады" . date('H:i') . "MSK) <br /><br />We осы қолайсыздықтар үшін кешірім сұраймыз";
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'ол қазірдің өзінде жойылған жіп көрсетілуі мүмкін list</b> дейін жойғаннан кейін <b>entire жаңарту үшін';
...
$lang['FORUM_PRUNE_EXPLAIN'] = 'Бұл сіз таңдаңыз күн саны шегінде орналастырылатын болған жоқ қандай да бір тақырыпты жояды. Сіз нөмірін енгізіңіз жоқ болса, содан кейін барлық тақырыптар жойылады. Ол <b>sticky</b> тақырыптарды және <b>announcements</b> жоймайды. Сіз қолмен сол тақырыптарды алып тастау қажет болады.';
...
$lang['NEWS_FORUM_ID'] = 'форумдар бірнеше форумдар <h6>Of <br /> көрсету үшін қандай үтірлермен бөлінген, көтереді. Мысал 1,2,3</h6>';
...
$lang['SEED_BONUS_TOR_SIZE'] = 'Сіз барлық тарату үшін бонустар есептеу келсе <h4>Minimum тарату бонустар </h4> <h6> марапатталатын болады, ол үшін бос қалдырыңыз. </h6>';
$lang['SEED_BONUS_USER_REGDATA'] = 'Сіз барлық пайдаланушыларға бонустар есептеуге келсе пайдаланушы трекера <h4>Minimum ұзындығы, бонустар </h4> <h6> марапатталатын болады, содан кейін бос қалдырыңыз. </h6>';
...
$lang['MAX_IMAGE_SIZE_EXPLAIN'] = 'Міне, бұл 0x0 үшін орнатылған .<br />If сіз Image Dimension бекітілуі үшін рұқсат етілген максимум (пиксель ені х биіктігі) анықтауға болады, бұл функция өшірілген. кейбір бейнелердің бұл мүмкіндікті салдарынан PHP жылы шектеулерге жұмыс істемейді.';
$lang['IMAGE_LINK_SIZE'] = 'Сурет Link Өлшемдері';
$lang['IMAGE_LINK_SIZE_EXPLAIN'] = 'Осы кескінді мөлшері жеткен анықталған болса, Image Кірістірілген View <br />if, тезірек салынған визуализацияланған қарағанда, сілтеме ретінде көрсетіледі, ол 0x0 үшін орнатылған .<br />If, бұл функция өшірілген (пиксель ені х биіктігі) қосылады. кейбір бейнелердің бұл мүмкіндікті салдарынан PHP жылы шектеулерге жұмыс істемейді.';
$lang['ASSIGNED_GROUP'] = 'тағайындалған тобы';

$lang['IMAGE_CREATE_THUMBNAIL'] = 'Пиктограмма жасау';
$lang['IMAGE_CREATE_THUMBNAIL_EXPLAIN'] = 'Әрқашан нобайды жасау. Бұл функция Ең сурет өлшемі қоспағанда, осы арнайы санаттағы шеңберінде барлық дерлік параметрлерін анықтайды. Бұл мүмкіндік бар Нобай лауазымына ішінде пайда болады, Пайдаланушы ол орнатылмаған болса, осы функция, орнатылатын Imagick талап ететінін нақты Image.<br />Please Ескертпе ашу үшін оны басуға болады немесе Қауіпсіз-режимі ТІ-ҰЗАРТУ қосулы болса PHP пайдаланылатын болады. Image-түрі PHP қолдау емес болса, бұл функция пайдаланылады емес болады.';
...
$lang['NOTE_ADMIN_EMPTY_GROUP_PERMISSIONS'] = 'ЕСКЕРІМ: <br />Within тізімделген Форумдар төмен пайдаланушылар сіздің әдетте файлдарды тіркеу үшін рұқсат етілген, бірақ ешқандай Extension Group қоса берілуі рұқсат етіледі, өйткені, сіздің Пайдаланушылар ештеңе бекітіңіз алмаймыз. олар әрекет жасасаңыз, олар қате туралы хабарларды алуға болады. Мүмкін, сіз осы Forums.<br /><br /> кезінде ADMIN рұқсат «Post файлдар \'орнатқыңыз';
...
$lang['BT_SELECT_FORUMS_EXPL'] = 'бірнеше форумдар таңдау кезінде <i>Ctrl</i> басып тұрыңыз';
...
$lang['SELF_MODERATED'] = 'Пайдаланушылар басқа форумға өз тақырыптарды <b>move</b> болады';
...
$lang['BT_SHOW_IP_ONLY_MODER'] = 'Құрдастарының <b>IP</b>s ғана модераторлар көрінеді';
$lang['BT_SHOW_PORT_ONLY_MODER'] = 'Құрдастарының <b>Port</b>s ғана модераторлар көрінеді';
...
$lang['REBUILD_SEARCH_DESC'] = 'іздеу үстелдер қалпына сіздің форумда Бұл сән ерік индексі әрбір пост. сіз көресіз Сіз тоқтатуға болады және сіз оны қайтадан іске келесі жолы сіз off.<br /><br />It қалдырды қайдан жалғастыру опция «цикл Хабарламалар» байланысты (оның барысын көрсету үшін ұзақ уақыт кетуі және «уақыт шектеуі мүмкін шалады ол аяқталғанша, әрине, сіз оны тоқтату қажет болмаса, «), сондықтан, оның прогресс беттен жылжыту емес өтінеміз.';

// Input screen
$lang['STARTING_POST_ID'] = 'post_id бастап';
$lang['STARTING_POST_ID_EXPLAIN'] = 'өңдеу from<br />You басынан бастап немесе сіз соңғы тоқтатылған қызметінен бастау үшін таңдауға болады бастайды Бірінші пост';
...
$lang['NUM_OF_POSTS_EXPLAIN'] = 'автоматты дБ табылған жалпы / қалған лауазымдар саны толтырылған process<br />It ның жалпы лауазымдарының саны';

$lang['POSTS_PER_CYCLE'] = 'цикл Хабарламалар';
$lang['POSTS_PER_CYCLE_EXPLAIN'] = 'ол төмен PHP / сервер күту уақыттарын болдырмау үшін cycle<br />Keep бір өңдеуге лауазымдарының саны';

$lang['REFRESH_RATE'] = 'Жаңару жиілігі';
$lang['REFRESH_RATE_EXPLAIN'] = 'Егер сіз осы өзгертуге қажеті жоқ cycle<br />Usually келесі өңдеу көшу дейін күту қанша уақыт (секунд) қалуға';
...
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Your PHP (қауіпсіз режимі) бапталған %s ӘКК тайм-аут бар, сондықтан бұл value</i> төменде қалады';
$lang['TIME_LIMIT_EXPLAIN_WEBSERVER'] = '<i>Your сервер бапталған %s ӘКК тайм-аут бар, сондықтан бұл value</i> төменде қалады';
...
$lang['DISABLE_BOARD_EXPLAIN_ALREADY'] = '<i>Your кеңесі қазірдің өзінде disabled</i> табылады';
...
$lang['INFO_PROCESSING_FINISHED_NEW'] = 'Сіз сәтті осы күннен кейін %s жаңа пост (лар) болған %s,<br />but бойынша post_id %s (%s өңделген хабарламалар) өңдеу аяқталды';
...
$lang['PROCESS_DETAILS'] = '<b>%s</b> бастап (жалпы <b>%s</b> тыс) <b>%s</b> үшін';
...
$lang['INFO_ESTIMATED_VALUES'] = '(*) Барлық бағаланған құндылықтар ағымдағы аяқталды пайызға approximately<br />based және аяқталған пайызы бағаланады мәндер нақты адамдарға жақын келеді арттырады нақты қорытынды values.<br />As көрсетуі мүмкін есептеледі.';

$lang['CLICK_RETURN_REBUILD_SEARCH'] = 'Іздеу қайта оралу үшін %shere%s басыңыз';
$lang['REBUILD_SEARCH_ABORTED'] = 'өңдеу кезінде сіз доғарылды %s.<br /><br />If post_id бойынша доғарылды іздеу болды қалпына келтіру, сіз қайтадан іздеу қалпына келтіру іске дейін кейбір минут күтуге тура келеді, сондықтан соңғы цикл аяқтауға болады.';
...
$lang['CALLSEED_MSG_SPAM'] = 'Сұрау өзінде бір рет сәтті (Мүмкін емес, сіз) <b>%s</b> болуы сұрау жіберу үшін <br /><br />The келесі мүмкіндік жіберілді.';
$lang['CALLSEED_HAVE_SEED'] = 'Тақырыбы (: </b> %d <b>Seeders) көмек қажет етпейді';

$lang['LOG_ACTION']['LOG_TYPE'] = [
    'mod_topic_delete' => 'Тақырыбы: <br /> <b>deleted</b>',
    'mod_topic_move' => 'Тақырыбы: <br /> <b>moved</b>',
    'mod_topic_lock' => 'Тақырыбы: <br /> <b>closed</b>',
    'mod_topic_unlock' => 'Тақырыбы: <br /> <b>opened</b>',
    'mod_topic_split' => 'Тақырыбы: <br /> <b>split</b>',
    ...
    'adm_user_delete' => 'Пайдаланушы: <br /> <b>deleted</b>',
    'adm_user_ban' => 'Пайдаланушы: <br /> <b>ban</b>',
    'adm_user_unban' => 'Пайдаланушы: <br /> <b>unban</b>',
];
...
$lang['TPL_NOT_URL'] = '<b>%s</b> - https:// URL болуы керек';
$lang['TPL_NOT_IMG_URL'] = '<b>%s</b> - https:// IMG_URL болуы керек';
...
$lang['SITEMAP_YANDEX_1'] = 'Егер Яндекс тіркелгісін пайдаланып <a href="https://webmaster.yandex.ru/sites/" target="_blank">Yandex Webmaster</a> сіздің сайты тіркеңіз.';
$lang['SITEMAP_YANDEX_2'] = 'Сіз тіркелген сайттың <a href="https://webmaster.yandex.ru/site/map.xml" target="_blank">Add sitemap</a>.';
...
$lang['EMAILER_SUBJECT'] = [
    ...
    'TOPIC_NOTIFY' => '%sағынындағы жауап туралы хабарлама',
