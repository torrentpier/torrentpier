...
foreach ($profile_fields as $field => $can_edit) {
    ...
    switch ($field) {
        ...
        case 'user_from':
            ...
            $tp_data['COUNTRY_SELECTED'] = (isset($lang['COUNTRIES'][$pr_data['user_from']]) || $pr_data['user_from'] === '0') ? render_flag($pr_data['user_from']) : $pr_data['user_from'];
            $tp_data['COUNTRY_SELECT'] = (isset($lang['COUNTRIES'][$pr_data['user_from']]) || $pr_data['user_from'] === '0') ? build_select('user_from', array_flip($lang['COUNTRIES']), $pr_data['user_from']) : '';
            break;
