...
<form method="post" action="{S_MODE_ACTION}">
    <table width="100%">
        <tr>
            <td class="tRight nowrap"><!-- IF S_VIEW_SELECT -->{L_VIEW}:&nbsp;{S_VIEW_SELECT}&nbsp;&nbsp;<!-- ENDIF --><input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption"/></td>
        </tr>
    </table>
    <table class="forumline">
        ...
        <tr>
            <td class="row1 nowrap">{L_NUMBER_OF_ATTACHMENTS}:</td>
            <td class="row2"><b>{NUMBER_OF_ATTACHMENTS}</b></td>
        </tr>
        <tr>
            <td class="row1 nowrap">{L_TOTAL_FILESIZE}:</td>
        ...
        <tr>
            <td class="row1 nowrap">{L_NUMBER_PMS_ATTACH}:</td>
            <td class="row2"><b>{NUMBER_OF_PMS}</b></td>
        </tr>
        <tr>
            <td class="row1 nowrap">{L_NUMBER_TOPICS_ATTACH}:</td>
            <td class="row2"><b>{NUMBER_OF_TOPICS}</b></td>
        </tr>
        <tr>
            <td class="row1 nowrap">{L_NUMBER_USERS_ATTACH}:</td>
...
<form method="post" action="{S_MODE_ACTION}">
    <table width="100%">
        <tr>
            <td class="tRight nowrap"><span class="med"><!-- IF S_VIEW_SELECT -->{L_VIEW}:&nbsp;{S_VIEW_SELECT}&nbsp;&nbsp;<!-- ENDIF --><input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption"></span></td>
        </tr>
    </table>
    <table class="forumline">
        <tr>
        ...
        <tr>
            <td class="row1 tRight" colspan="2"><span class="gen">{L_FORUM}:&nbsp;</span></td>
            <td class="row2" colspan="2"><select class="post" name="search_forum">{S_FORUM_OPTIONS}</select></td>
        </tr>
        <tr>
            <td class="row1 tRight" colspan="2"><span class="gen">{L_SORT_BY}:&nbsp;</span></td>
            <td class="row2" colspan="2">{S_SORT_OPTIONS}</td>
        <tr>
            <td class="row1 tRight" colspan="2"><span class="gen">{L_SORT}:&nbsp;</span></td>
...
<form method="post" action="{S_MODE_ACTION}">
    <table width="100%">
        <tr>
            <td class="tRight nowrap"><span class="med"><!-- IF S_VIEW_SELECT -->{L_VIEW}:&nbsp;{S_VIEW_SELECT}&nbsp;<!-- ENDIF -->{L_SORT_BY}:&nbsp;{S_MODE_SELECT}&nbsp;{L_ORDER}&nbsp;{S_ORDER_SELECT}&nbsp;&nbsp;<input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption"></span></td>
        </tr>
    </table>
    <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
        ...
        <!-- BEGIN memberrow -->
        <tr>
            <td class="{memberrow.ROW_CLASS} tCenter"><span class="gen">{memberrow.ROW_NUMBER}</span>
            </td>
            <td class="{memberrow.ROW_CLASS} tCenter"><span class="gen"><a href="{memberrow.U_VIEW_MEMBER}" class="gen">{memberrow.USERNAME}</a></span>
            </td>
            <td class="{memberrow.ROW_CLASS} tCenter"><b>{memberrow.TOTAL_ATTACHMENTS}</b></td>
            <td class="{memberrow.ROW_CLASS} tCenter"><b>{memberrow.TOTAL_SIZE}</b></td>
        </tr>
        <!-- END memberrow -->
    </table>
    <table width="100%">
        <tr>
            ...
            <td class="tRight"><span class="nav">{PAGINATION}&nbsp;</span></td>
        </tr>
    </table>
</form>
...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
    ...
    <table class="forumline">
        ...
        <!-- BEGIN attachrow -->
        <tr>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen">&nbsp;{attachrow.ROW_NUMBER}&nbsp;</span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen"><a href="{attachrow.U_VIEW_ATTACHMENT}" class="gen" target="_blank">{attachrow.FILENAME}</a></span>
            </td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen"><input type="text" size="40" maxlength="200" name="attach_comment_list[]" value="{attachrow.COMMENT}" class="post"></span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen">{attachrow.EXTENSION}</span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen"><b>{attachrow.SIZE}</b></span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen"><input type="text" size="5" maxlength="10" name="attach_count_list[]" value="{attachrow.DOWNLOAD_COUNT}" class="post"></span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="small">{attachrow.POST_TIME}</span></td>
            <td class="{attachrow.ROW_CLASS} tCenter"><span class="gen">{attachrow.POST_TITLE}</span></td>
            <td class="{attachrow.ROW_CLASS} tCenter">{attachrow.S_DELETE_BOX}</td>
            {attachrow.S_HIDDEN}
        </tr>
        <!-- END attachrow -->
        <tr>
    ...
    <table width="100%">
        <tr>
            <td class="tRight nowrap" valign="top"><b><span class="small"><a href="javascript:select_switch(true);" class="small">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="small">{L_UNMARK_ALL}</a></span></b></td>
        </tr>
    </table>
    <table width="100%">
        <tr>
