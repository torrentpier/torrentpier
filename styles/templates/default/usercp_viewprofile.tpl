...
#traf-stats-tbl th { padding: 2px <!-- IF CFG_SB_E -->11<!-- ELSE -->22<!-- ENDIF -->px 3px; }
<!-- IF TRAF_STATS -->
				...
				<td colspan="2" class="pad_4">
					<table id="traf-stats-tbl" <!-- IF TRAF_STATS -->style="display: none;"<!-- ENDIF --> class="bCenter borderless" cellspacing="1">
						<tr class="row3">
							...
							<th>{L_RELEASED}</th>
							<th>{L_BONUS}</th>
							<!-- IF CFG_SB_E --><th>{L_SEED_BONUS}</th><!-- ENDIF -->
						</tr>
						<tr class="row1">
							<td>{L_TD_TRAF}</td>
							...
							<!-- IF CFG_SB_E --><td class="points">{TD_POINTS}</td><!-- ENDIF -->
						</tr>
						<tr class="row5">
							<td>{L_YS_TRAF}</td>
							...
							<!-- IF CFG_SB_E --><td class="points">{YS_POINTS}</td><!-- ENDIF -->
						</tr>
						<tr class="row1">
							<td>{L_TOTAL_TRAF}</td>
							...
							<!-- IF CFG_SB_E --><td id="user_points"><span class="editable bold points">{USER_POINTS}</span></td><!-- ENDIF -->
						</tr>
						<tr class="row5">
							<td colspan="1">{L_MAX_SPEED}</td>
							<td colspan="2">{L_DL_DL_SPEED}: {SPEED_DOWN}</td>
							<td colspan="2">{L_DL_UL_SPEED}: {SPEED_UP}</td>
							<!-- IF CFG_SB_E --><td colspan="1"><!-- IF PROFILE_USER --><a href="profile.php?mode=bonus">{L_EXCHANGE}</a><!-- ENDIF --></td><!-- ENDIF -->
						</tr>
					</table>
				</td>
			</tr>
