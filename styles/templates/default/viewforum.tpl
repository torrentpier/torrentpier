...
<tr id="tr-{t.TOPIC_ID}">
	...
	<!-- BEGIN tor -->
		<div>
			...
			<div style="padding-top: 2px" class="small"><!-- IF t.TOR_FROZEN -->{t.tor.TOR_SIZE}<!-- ELSE --><a href="{DOWNLOAD_URL}{t.tor.ATTACH_ID}" title="{L_DL_TORRENT}" class="small" style="text-decoration: none">{t.tor.TOR_SIZE}</a> <!-- IF t.tor.MAGNET -->{t.tor.MAGNET}<!-- ENDIF --><!-- ENDIF --></div>
		</div>
	<!-- END tor -->
	</td>
