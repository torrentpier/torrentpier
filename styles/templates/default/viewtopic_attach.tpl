...
<table class="attach bordered med">
	...
	<tr class="row1">
		...
		<td width="15%" rowspan="4" class="tCenter pad_6">
			...
			<hr>
			<a href="{postrow.attach.tor_reged.tor_server.TORR_SERVER_M3U_LINK}" target="_blank"><p><img alt="{L_SHOW_M3U_FILE}" src="{postrow.attach.tor_reged.tor_server.TORR_SERVER_M3U_ICON}" width="21" height="21" border="0"></p>{L_SHOW_M3U_FILE}</a>
			<!-- ENDIF -->
			<!-- END tor_server -->
		</td>
	</tr>
