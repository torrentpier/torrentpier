	...
	<td class="message td2" rowspan="2">
		...
		<div class="post_head">
			...
			<p style="float: right;<!-- IF TEXT_BUTTONS --> padding: 3px 2px 4px;<!-- ELSE --> padding: 1px 6px 2px;<!-- ENDIF -->" class="post_btn_1">
				...
				<!-- IF postrow.PIN --><a class="txtb" href="<!-- IF $bb_cfg['use_ajax_posts'] -->" onclick="edit_post({postrow.POST_ID}, 'pin'); return false;<!-- ELSE -->{PIN_POST_URL}{postrow.POST_ID}<!-- ENDIF -->">{PIN_POST_IMG}</a>{POST_BTN_SPACER}<!-- ENDIF -->
