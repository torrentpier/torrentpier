...
return function (Router $router): void {
    ...
    // POST
    $router->post('/poll', new LegacyAdapter($basePath . '/app/Http/Controllers/poll.php', 'vote', ['manage_session' => true]));
    ...
    $router->any('/modcp', new LegacyAdapter($basePath . '/app/Http/Controllers/modcp.php', options: ['manage_session' => true]));
    $router->any('/posting', new LegacyAdapter($basePath . '/app/Http/Controllers/posting.php'));
    $router->any('/privmsg', new LegacyAdapter($basePath . '/app/Http/Controllers/privmsg.php', 'pm', ['manage_session' => true]));
    $router->any('/search', new LegacyAdapter($basePath . '/app/Http/Controllers/search.php', options: ['manage_session' => true]));
    $router->any('/tracker', new LegacyAdapter($basePath . '/app/Http/Controllers/tracker.php', options: ['manage_session' => true]));
