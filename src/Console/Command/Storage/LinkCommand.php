...
namespace TorrentPier\Console\Command\Storage;
...
/**
 * Creates a symbolic link from public/storage to storage/public
 */
#[AsCommand(
    name: 'storage:link',
    description: 'Create a symbolic link from "public/storage" to "storage/public"'
)]
class LinkCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $target = STORAGE_PUBLIC_DIR;  // storage/public
        $link = PUBLIC_DIR . '/storage';  // public/storage
        $relativePath = '../storage/public';
