...
class Cron
{
    ...
    public static function insert_cron_job(array $cron_arr): void
    {
        ...
        if ($row) {
            ...
            $message = $langmode . '<br /><br />' . \sprintf(__('CLICK_RETURN_JOBS_ADDED'), '<a href="javascript:history.back(-1)">', '</a>') . '<br /><br />' . \sprintf(__('CLICK_RETURN_JOBS'), '<a href="admin_cron.php?mode=list">', '</a>') . '<br /><br />' . \sprintf(__('CLICK_RETURN_ADMIN_INDEX'), '<a href="index.php">', '</a>');
