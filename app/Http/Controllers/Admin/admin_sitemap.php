...
$s_mess = __('SITEMAP_CREATED') . ': <b>' . bb_date($new['sitemap_time'], config()->get('localization.date_formats.post')) . '</b> ' . __('SITEMAP_AVAILABLE') . ': <a href="' . make_url('sitemap.xml') . '" target="_blank">' . make_url('sitemap.xml') . '</a>';
