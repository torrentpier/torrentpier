...
<tr class="{list.ROW_CLASS} hl-tr">
	...
	<td class="nowrap tCenter">
		<a href="admin_cron.php?mode=run&id={list.CRON_ID}" title="{L_CRON_RUN}"><i class="icon-play cron-icon"></i></a>
		<a href="admin_cron.php?mode=edit&id={list.CRON_ID}" title="{L_CRON_EDIT_HEAD_EDIT}"><i class="icon-pencil cron-icon"></i></a>
		<a href="admin_cron.php?mode=delete&id={list.CRON_ID}" title="{L_CRON_DEL}" onclick="return cfm('{L_DELETE_JOB}');"><i class="icon-trash-2 cron-icon"></i></a>
	</td>
</tr>
<!-- END list -->
</table>
