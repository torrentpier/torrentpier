...
(
  ...
  `user_password`        VARCHAR(255)
                           CHARACTER SET utf8
                             COLLATE utf8_bin  NOT NULL DEFAULT '',
  `user_password_method` ENUM ('md5', 'password_hash')  DEFAULT NULL,
...
VALUES ('-1', '0', 'Guest', '$2y$10$sfZSmqPio8mxxFQLRRXaFuVMkFKZARRz/RzqddfYByN3M53.CEe.O', 'password_hash', '0', '0',
        ...
        '1900-01-01',
        '', '', '', '', '', '', '', '', '', '', '', '', '0', '0.00', 'default'),
       ('-746', '0', 'bot', '$2y$10$sfZSmqPio8mxxFQLRRXaFuVMkFKZARRz/RzqddfYByN3M53.CEe.O', 'password_hash', '0', '0',
        '0', UNIX_TIMESTAMP(), '0', '0', '0', '',
        'ru', '0',
        '0', '0',
        '144', '0',
       ...
       ('2', '1', 'admin', '$2y$10$QeekUGqdfMO0yp7AT7la8OhgbiNBoJ627BO38MdS1h5kY7oX6UUKu', 'password_hash', '0', '0',
